...
export default function WorkspaceActivityPanel({
  ...
  return (
    <div className="space-y-4">
      {/* Top banner: workspace description */}
      ...
      {/* Two-column layout: Left Chats, Right Documents */}
      <div className="grid grid-cols-2 gap-6">
        {/* Left Column: Recent Chats */}
        <div className="space-y-3 min-w-0">
          <p className="text-sm font-medium text-gray-500 dark:text-gray-300">{t('activity.recentChats')}</p>
        ...
        <div className="space-y-3 min-w-0">
          <p className="text-sm font-medium text-gray-500 dark:text-gray-300">{t('activity.recentDocuments')}</p>
