  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900">
        <h1 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Project Sandbox</h1>
        <button
          disabled
      ...
      <div className="flex-1 flex items-center justify-center bg-gray-50 dark:bg-zinc-900">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-medium text-gray-400 dark:text-gray-500 mb-2">Coming Soon</h2>
          <p className="text-sm text-gray-300 dark:text-gray-600">Project Sandbox feature is under development</p>
        </div>
      </div>
    </div>
  );
